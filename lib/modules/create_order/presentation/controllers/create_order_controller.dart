...
// import '../../../all_products/data/models/get_companies_model/get_companies_model.dart';
// import '../../../all_products/data/models/get_products_model/get_all_products_model.dart';
...
//       selectedSector.value = arguments['selectedSector'] as GetSectorsModel?;
//     }
//   }
...
//         customerAddress:
//             "${selectedSector.value!.sectorName} - ${selectedTown.value!.townName}",
//         customerId: selectedCustomer.value!.customerId.toString(),
//         customerName: selectedCustomer.value!.customerName!,
//         companies: _prepareCompaniesForOrder(),
...
//       companies.add(
//         OrderCompanies(
//           companyOrderId: 0, // Auto-increment in database
//           orderId: 0, // Set when order is inserted
//           companyId: companyId,
