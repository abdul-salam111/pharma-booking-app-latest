...
@JsonKey(name: "SalesmanOrderId") int? get salesmanOrderId;@JsonKey(name: "DeviceOrderID") int? get deviceOrderId;@JsonKey(name: "CustomerId") int? get customerId;@JsonKey(name: "SalesmanId") int? get salesmanId;@JsonKey(name: "DeviceOrderDateTime") DateTime? get deviceOrderDateTime;@JsonKey(name: "OrderRows") List<SyncOrderRow>? get orderRows;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,salesmanOrderId,deviceOrderId,customerId,salesmanId,deviceOrderDateTime,const DeepCollectionEquality().hash(orderRows));

@override
String toString() {
  return 'SyncOrdersModel(salesmanOrderId: $salesmanOrderId, deviceOrderId: $deviceOrderId, customerId: $customerId, salesmanId: $salesmanId, deviceOrderDateTime: $deviceOrderDateTime, orderRows: $orderRows)';
}
...
@useResult
$Res call({
@JsonKey(name: "SalesmanOrderId") int? salesmanOrderId,@JsonKey(name: "DeviceOrderID") int? deviceOrderId,@JsonKey(name: "CustomerId") int? customerId,@JsonKey(name: "SalesmanId") int? salesmanId,@JsonKey(name: "DeviceOrderDateTime") DateTime? deviceOrderDateTime,@JsonKey(name: "OrderRows") List<SyncOrderRow>? orderRows
});
...
/// Create a copy of SyncOrdersModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? salesmanOrderId = freezed,Object? deviceOrderId = freezed,Object? customerId = freezed,Object? salesmanId = freezed,Object? deviceOrderDateTime = freezed,Object? orderRows = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "SalesmanOrderId")  int? salesmanOrderId, @JsonKey(name: "DeviceOrderID")  int? deviceOrderId, @JsonKey(name: "CustomerId")  int? customerId, @JsonKey(name: "SalesmanId")  int? salesmanId, @JsonKey(name: "DeviceOrderDateTime")  DateTime? deviceOrderDateTime, @JsonKey(name: "OrderRows")  List<SyncOrderRow>? orderRows)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SyncOrdersModel() when $default != null:
return $default(_that.salesmanOrderId,_that.deviceOrderId,_that.customerId,_that.salesmanId,_that.deviceOrderDateTime,_that.orderRows);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "SalesmanOrderId")  int? salesmanOrderId, @JsonKey(name: "DeviceOrderID")  int? deviceOrderId, @JsonKey(name: "CustomerId")  int? customerId, @JsonKey(name: "SalesmanId")  int? salesmanId, @JsonKey(name: "DeviceOrderDateTime")  DateTime? deviceOrderDateTime, @JsonKey(name: "OrderRows")  List<SyncOrderRow>? orderRows)  $default,) {final _that = this;
switch (_that) {
case _SyncOrdersModel():
return $default(_that.salesmanOrderId,_that.deviceOrderId,_that.customerId,_that.salesmanId,_that.deviceOrderDateTime,_that.orderRows);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "SalesmanOrderId")  int? salesmanOrderId, @JsonKey(name: "DeviceOrderID")  int? deviceOrderId, @JsonKey(name: "CustomerId")  int? customerId, @JsonKey(name: "SalesmanId")  int? salesmanId, @JsonKey(name: "DeviceOrderDateTime")  DateTime? deviceOrderDateTime, @JsonKey(name: "OrderRows")  List<SyncOrderRow>? orderRows)?  $default,) {final _that = this;
switch (_that) {
case _SyncOrdersModel() when $default != null:
return $default(_that.salesmanOrderId,_that.deviceOrderId,_that.customerId,_that.salesmanId,_that.deviceOrderDateTime,_that.orderRows);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,salesmanOrderId,deviceOrderId,customerId,salesmanId,deviceOrderDateTime,const DeepCollectionEquality().hash(_orderRows));
...
/// Create a copy of SyncOrdersModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? salesmanOrderId = freezed,Object? deviceOrderId = freezed,Object? customerId = freezed,Object? salesmanId = freezed,Object? deviceOrderDateTime = freezed,Object? orderRows = freezed,}) {
